...
## Quick Guide: Which Channel Do I Use?

<CardGrid stagger>
  <Card title="Major Announcements" icon="rocket">
  ...
  <Card title="Leadership Updates" icon="pen">
    **Best Channel Combination:**
    1. Email
    2. Banyan posts
...
<Card title="Overview">
  ...
  <Tabs>
    ...
    <TabItem label="Best Practices">
      ...
      - Include a section on next steps and/or highlight deadlines
      - Consider timing for different time zones (e.g., scheduling an email for a more appropriate time)
    </TabItem>
  </Tabs>
</Card>
...
<Card title="Overview">
  Teams works best for informal coordination and real-time collaboration, when your team needs to move fast together. As it's a more casual platform, avoid using Teams for formal or critical communication needing broader stakeholder input.

  <Tabs>
    <TabItem label="When to Use">
      - Major product launches requiring immediate team coordination
      - Local initiatives that need collaborative input
...
<Card title="Overview">
  ...
  <Tabs>
    ...
    <TabItem label="Planning Checklist">
      - Schedule regularly (e.g., monthly or quarterly)
