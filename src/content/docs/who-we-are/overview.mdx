...
We use a variety of channels to connect and collaborate with fellow Internal Comms colleagues. These are different than the channels and tools we use to launch our comms initiatives and are for planning and development purposes. For tools and resources to launch campaigns, see [Channels & Methods](/implement/channels/).
